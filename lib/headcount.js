...
export async function getEventHeadcount(eventId) {
  ...
  const confirmedVolunteers = capacity != null ? volunteerRegs.slice(0, capacity) : volunteerRegs;
  const waitlistedVolunteers = capacity != null ? volunteerRegs.slice(capacity) : [];
