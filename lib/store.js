...
/** Per-person event context — Supabase only; the JSON dev store has no index
 *  by phone and this is a nicety, not something dev needs. */
export async function lastEventIdForPhone(phone) {
  return useSupabase() ? supa.lastEventIdForPhone(phone) : null;
}
